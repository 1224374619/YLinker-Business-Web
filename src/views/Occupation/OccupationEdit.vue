<template>
  <div class="occupation-edit">
    <div class="body">
      <h1>编辑职位</h1>
      <div class="form">
        <el-form ref="form" :rules="rules" :model="form" label-width="80px">
          <el-form-item label="职位 ID" prop="comment">
            {{ occupationId }}
          </el-form-item>
          ...
          <el-form-item class="operations">
            <el-button @click="gotoOccupationDetailUI">取消</el-button>
...
export default class OccuptaionEdit extends Vue {
  ...
  gotoOccupationDetailUI() {
    this.$router.push({ path: `/occupation/${this.occupationId}` });
  }
